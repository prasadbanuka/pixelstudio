$("#wedding-booking-form").validator().on("submit", function (event) {
...
function formSuccess(){
    $("#wedding-booking-form")[0].reset();
    submitMSG(true, "Message Submitted!")
}

function formError(){
    $("#wedding-booking-form").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
        $(this).removeClass();
    });
}
