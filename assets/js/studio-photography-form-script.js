$("#studioPhotographyForm").validator().on("submit", function (event) {
...
function submitForm(){
    ...
    $.ajax({
        type: "POST",
        url: "../../../assets/php/studio-photography-form-process.php",
...
function formSuccess(){
    $("#studioPhotographyForm")[0].reset();
    submitMSG(true, "Message Submitted!")
}

function formError(){
    $("#studioPhotographyForm").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
        $(this).removeClass();
    });
}
