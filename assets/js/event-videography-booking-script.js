$("#event-videography-booking-form").validator().on("submit", function (event) {
...
function formSuccess(){
    $("#event-videography-booking-form")[0].reset();
    submitMSG(true, "Message Submitted!")
}

function formError(){
    $("#event-videography-booking-form").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
        $(this).removeClass();
    });
}
