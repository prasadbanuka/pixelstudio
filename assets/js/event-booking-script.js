$("#event-booking-form").validator().on("submit", function (event) {
...
function submitForm(){
    ...
    $.ajax({
        type: "POST",
        url: "../../../assets/php/event-booking-form-process.php",
...
function formError(){
    $("#event-booking-form").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
        $(this).removeClass();
    });
}
