...
<body>
    ...
    <div class="container my-5 pt-4">
        ...
        <p class="fs-5 text-center my-5">Thanks for choosing us. Please answer these questions to go ahead and confirm
          ...
          <!-- Contact Form  Starts  -->
          <form role="form" id="commercialStudioPhotographyForm" class="contact-form mt-5 pt-4" data-toggle="validator" class="shake">
    ...
    <script type="text/javascript" src="../../../assets/js/commercial-studio-photography-form-script.js"></script>
