...
<body>
    ...
    <div class="container my-5 pt-4">
        ...
        <!-- Contact Form  Starts  -->
        <form role="form" id="commercialOutdoorPhotographyForm" class="contact-form mt-5 pt-4" data-toggle="validator" class="shake">
    ...
    <script type="text/javascript" src="../../../assets/js/commercial-outdoor-photography-form-script.js"></script>
