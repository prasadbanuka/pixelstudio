...
<body>
   ...
   <!-- Contact Form  Starts  -->
   <form role="form" id="event-booking-form" class="contact-form mt-5 pt-4" data-toggle="validator" class="shake">
...
<!-- Contact Form Ends -->
    ...
    <script type="text/javascript" src="../../../assets/js/event-booking-script.js"></script>
