    ...
    <div class="container my-5 pt-4">
        ...
        <ul class="my-5 fs-5">
            <li class="mb-4">We are a team of professional photographers. Please send your wedding / engagement /
                elopement date to check the availability. </li>
            <li>Please refer to our price list. </li>
            <li>15% Gst will charge on top of the prices you see.</li>
            <li>Minimum we do is 2 hours</li>
            <li>You will receive high-quality edited photos on a downloadable private link.</li>
            <li>If you want videography please request as we have a discounted package for both Photography and
                videography.</li>
        </ul>
        <hr />
